      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 16,
            runSpacing: 16,
            children: kpis.map((k) => SizedBox(width: 200, child: KpiCard(title: k.title, value: k.value, unit: k.unit))).toList(),
          ),
          const SizedBox(height: 28),
          Text('近 7 日访问量', style: Theme.of(context).textTheme.titleMedium),
          const SizedBox(height: 12),
          SizedBox(height: 200, child: _ChartPlaceholder(data: MockData.visits7)),
          const SizedBox(height: 28),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: data.map((e) {
          ...
          final maxV = data.map((x) => (x['value'] as num).toDouble()).reduce((a, b) => a > b ? a : b);
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('${e['label']}', style: Theme.of(context).textTheme.bodySmall, overflow: TextOverflow.ellipsis),
                ],
              ),
            ),
          );
    ...
    return Container(
      ...
      child: Column(
        children: orders.map((o) => ListTile(
          title: Text('${o['id']}', style: Theme.of(context).textTheme.bodyMedium),
          subtitle: Text('${o['date']}', style: Theme.of(context).textTheme.bodySmall),
          trailing: Text('${o['amount']}', style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: AppColors.primary)),
        )).toList(),
      ),
    );
  }
